...
const ProductDetail = (props) => {
  const { title, imageUrl, price, description, link } = props;
  const { id } = useParams();
  const product = productData.find((news) => news.id === id);
  if (!product) {
...
<section class="py-5">
  ...
  <div class="border rounded-4 mb-3 d-flex justify-content-center">
    <a data-fslightbox="mygalley" class="rounded-4" target="_blank" data-type="image" href={product.imageUrl}>
    <img style={{ maxWidth: "100%", maxHeight: "100vh", margin: "auto" }} src={product.imageUrl} alt="Product" />
    </a>
  </div>
  <div class="d-flex justify-content-center mb-3">
    <a data-fslightbox="mygalley" class="border mx-1 rounded-2" target="_blank" data-type="image" href={imageUrl} className="item-thumb">
      <img style={{width:"60", height:"60"}}  class="rounded-2" src={product.imageUrl} alt="Thumbnail 1" />
    </a>
    {/* <!-- Các thẻ a và hình ảnh khác ở đây --> */}
  </div>
